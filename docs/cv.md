...
مطوار تطبيقات شغوف بخبرة واسعة في **Flutter** و **React Native** و **Typescript** و**Odoo** و**الذكاء الاصطناعي (AI)**، أمتلك القدرة على بناء أنظمة قوية ومرنة للمؤسسات، مع التركيز على الأداء، سهولة الاستخدام، وقابلية التوسع.
...
- **الذكاء الاصطناعي:** OpenAI API, LangChain, AI Agents, Prompt Engineering
