      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        >
          ...
          <p className='text-xl text-gray-400 max-w-3xl mx-auto'>
            مطور تطبيقات ومهندس ذكاء اصطناعي بخبرة قيادية كمدير تنفيذي للبرمجيات، متخصص في بناء أنظمة ذكية ومرنة للمؤسسات، مع التركيز على حلول AI المتقدمة والمنصات العقارية والاستثمارية المبتكرة.
          </p>
        </motion.div>
            ...
            <div className='space-y-4'>
              <div className='bg-dark-800 border border-gray-700 rounded-xl p-6'>
                ...
                <div className='flex flex-col gap-3'>
                  ...
                  <a
                    href='/when_start.pdf'
                    download='Student_Verification_Letter_MEDIU.pdf'
                    target='_blank'
                    rel='noopener noreferrer'
