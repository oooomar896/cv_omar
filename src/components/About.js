        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="space-y-4">
              <div className="bg-dark-800 border border-gray-700 rounded-xl p-6">
                ...
                <p className="text-gray-400 mb-3">
                  تخرجت بمرتبة الشرف مع تركيز على تطوير البرمجيات وهندسة النظم
                </p>
                <a
          ...
          >
            <div className="flex items-center space-x-4 space-x-reverse">
              ...
              <div>
                <h3 className="text-2xl font-bold text-white">الخبرة العملية</h3>
                <p className="text-gray-400">تصميم حلول مخصصة وإدارة المشاريع</p>
              </div>
            </div>
