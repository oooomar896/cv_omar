        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="space-y-4">
              ...
              >
                مطور تطبيقات شغوف بخبرة واسعة في <span className="text-primary-400">Flutter</span> و{' '}
                <span className="text-secondary-400">React Native</span> و{' '}
                <span className="text-accent-400">Odoo</span>، أمتلك القدرة على بناء أنظمة قوية ومرنة للمؤسسات.
              </motion.p>
            </div>
